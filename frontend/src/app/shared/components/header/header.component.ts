...
import { LoginDetailsModalComponent } from "../../../features/modals/login_details_modal.component";

@Component({
  selector: "app-header",
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, LoginDetailsModalComponent],
  template: `
    <header class="site-header" [class.scrolled]="isScrolled()" role="banner">
      <div class="container header-container">
        ...
        <a
          routerLink="/"
          class="brand-logo"
          [attr.aria-label]="content.brand.homepageAriaLabel"
        >
          <img
            class="logo-image"
        ...
        <nav class="desktop-nav" role="navigation" aria-label="Main Navigation">
          ...
          <a routerLink="/delivery-process" routerLinkActive="active"
            >Delivery Process</a
          >
        ...
        <div class="header-actions">
          ...
          <!-- User Profile / Auth Signin Wrapper -->
          <div 
            class="signin-wrap" 
          ...
          >
            @if(isModalOpen()){
              <app-login-modal (close)="closeModal()"></app-login-modal>
            }
          </div>
        </div>
      </div>
      ...
      >
        <nav class="mobile-nav">
          ...
          <a routerLink="/delivery-process" (click)="closeMenu()"
            >Delivery Process</a
          >
  ...
  styles: [
    `
      .signin-wrap {
        ...
        border-radius: 100%;
        position: relative;
        border: 2px solid var(--color-teal-dark, #0d9488);
        transition: transform 0.2s ease, border-color 0.2s ease;
      }
      .signin-wrap:hover {
        cursor: pointer;
        transform: translateY(-2px);
        border-color: var(--color-teal-accent, #00f2fe);
      }
      .site-header {
        position: sticky;
        top: 0;
      ...
      .desktop-nav {
        ...
        a::after {
          ...
          width: 100%;
          height: 2px;
          background: var(--color-teal-accent, #00f2fe);
          transform: scaleX(0);
      ...
      @media (max-width: 640px) {
        ...
        .mobile-backdrop { inset: 64px 0 0 0; }
